...
class AYHeroDoingBoNo19 : BaseAnYueHeroDoing(),
...
//es8  es4 ye5   6e0 y80  y50 y56 e04
    ...
    enum class Guan(val des: String? = null) {
        /**
         * 先铁骑石头放下面，然后除了鱼人土灵，其他全满
         */
        g1("先铁骑石头放下面，然后除了鱼人土灵，其他全满"),
...
//                    gk1Over = this
//                }
                tieqi.isFull() && shitou.isFull() && houyi.isFull() && dianfa.isFull() && dijing.isFull() && dapao.isFull() && niutou.isFull()
            }
...
//        }
        ...
        if (guanka == Guan.g1) {//第一阶段
            ...
            if (!tieqi.isInCar() || !shitou.isInCar()) {//石头铁骑放下面一行
                ...
                return defaultDealHero(heros, arrayListOf(houyi, dianfa, tieqi, niutou, shitou, dijing, dapao))
            }
