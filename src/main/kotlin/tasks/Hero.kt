...
object Hero : Guanka.ChangeListener {
    ...
    private val caijiList2 = arrayListOf<BufferedImage>()
    private val caijiList3 = arrayListOf<BufferedImage>()
    ...
    private fun isImgExist(caijiList: List<BufferedImage>,img: BufferedImage): Boolean {
        caijiList.forEach {
            if (ImgUtil.isImageSim(img, it,0.99)) {
                return true
            }
        }
        return false
