...
class HBHuolingHeroDoingBo : BaseHBHeroDoing(),
...
//            }
            ...
            var fullList = arrayListOf( nvwang, jiaonv, saman, wangjiang,shahuang, zhanjiang)//防止没满
//            if (isBaoku()) {
//                fullList.add(bingqi)
//            }
            var index = defaultDealHero(
...
//            }
           ...
           var index = heros.indexOf(jiaonv)//这里其实就没娇女了，不过，先留着吧(140_1中就会满娇女了)
            ...
            var fullList = arrayListOf(zhanjiang, nvwang, shahuang, jiaonv, wangjiang, saman, guangqiu)
            var index = defaultDealHero(
                heros,
                fullList
            )
