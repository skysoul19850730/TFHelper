...
class HBZhanNvHeroDoingBo1 : BaseHBHeroDoing(),
...
//        }
    ...
    fun isGkOver(g: Guan): Boolean {
        ...
        if (g == Guan.g151) return Zhuangbei.getZhuangBei() == needZhuangbei
...
//        if (g == Guan.g140) return Zhuangbei.isYandou() && saman.isFull()
        ...
        return when (g) {
            ...
            Guan.g91 -> {
                bingqi.isFull() && nvwang.isFull() && shahuang.isFull()
            }
            ...
            Guan.g161 -> {
                nvwang.isFull() && shahuang.isFull() && wangjiang.isFull()
            }
...
//            }
            ...
            var fullList = arrayListOf(nvwang, shahuang, saman, zhanjiang, bingqi, jiaonv)
//            if (isBaoku()) {
//                fullList.add(bingqi)
//            }
            var index = defaultDealHero(
