...
class HBZhanNvHeroDoingZiQiang3 : BaseHBHeroDoing(),
...
//es8  es4 ye5   6e0 y80  y50 y56 e04
    ...
    val ganglie = HeroBean("ganglie", 30)
...
//        downed.invoke(false)
    ...
    fun isGkOver(g: Guan): Boolean {
        ...
        if(g == Guan.g151_1)return Zhuangbei.isLongxin() && ganglie.isFull()
...
//            }
           ...
           var index = heros.indexOf(jiaonv)//这里其实就没娇女了，不过，先留着吧(140_1中就会满娇女了)
            ...
            var index = heros.indexOf(ganglie)
            if (index > -1) {
                return index
            }
