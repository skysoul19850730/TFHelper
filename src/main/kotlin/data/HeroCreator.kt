...
object HeroCreator{
    ...
    val bingniao = HeroBuilder("bingniao")
    val bingnv = HeroBuilder("bingnv")
    val bingqi = HeroBuilder("bingqi", isMohua = true)
    ...
    val haiyao = HeroBuilder("haiyao", isMohua = true)
    val houyi = HeroBuilder("houyi")
    val houzi = HeroBuilder("houzi", isMohua = true)
    ...
    val niutou = HeroBuilder("niutou", isMohua = true)
